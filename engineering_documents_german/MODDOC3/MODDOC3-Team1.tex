...
\chead[Multicast Test Tool - Moduldokumentation Controller/Profile - SPAM Software Programming And More]{Multicast Test Tool - Moduldokumentation Controller/Profile - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={Moduldokumentation Controller/Profile},
    pdfauthor={Team 1},
    pdfsubject={Moduldokumentation Controller/Profile},
