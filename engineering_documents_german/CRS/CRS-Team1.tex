...
\chead[Multicast Test Tool - Customer Requirements Specification - SPAM Software Programming And More]{Multicast Test Tool - Customer Requirements Specification - SPAM Software Programming And More} 
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={CRS},
	pdfauthor={Team 1},
	pdfsubject={CRS - Customer Requirements Specification},
