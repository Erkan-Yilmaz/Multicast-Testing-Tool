...
\setmyauthor{David Hildenbrand, Jeffrey Jedele , Ramin Safarpour, Tobias Schoknecht, Tobias St"ockel, Konstantin Weitz}
\setmysubject{Customer Requirements Specification}
...
\author{%
	...
	\begin{tabular}{lcl}%
		...
		Kategorie & : & Öffentliches Dokument\\
		Version & : & 1.0\\
	 \end{tabular}%
	}
}
