...
\usepackage{enumerate}      % erlaubt z.B. das Verwenden von Buchstaben als
                            % Aufzählungssymbol
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\chead[Multicast Test Tool - System Test Plan - SPAM Software Programming And More]{Multicast Test Tool - System Test Plan - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={STP},
	pdfauthor={Team 1},
	pdfsubject={STP - System Test Plan},
