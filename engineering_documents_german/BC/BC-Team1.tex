...
\chead[Multicast Test Tool - Business Case - SPAM Software Programming And
More]{Multicast Test Tool - Business Case - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={BC},
	pdfauthor={Team 1},
	pdfsubject={BC - Business Case},
