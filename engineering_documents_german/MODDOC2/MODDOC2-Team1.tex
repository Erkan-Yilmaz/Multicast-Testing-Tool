...
\chead[Multicast Test Tool - Moduldokumentation GUI-Logik - SPAM Software Programming And More]{Multicast Test Tool - Moduldokumentation GUI-Logik - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={Moduldokumentation GUI-Logik},
	pdfauthor={Team 1},
	pdfsubject={Moduldokumentation GUI-Logik},
