...
\usepackage[table]{xcolor}		% Farbdefinitionen möglich
...
\chead[Multicast Test Tool - System Test Report - SPAM Software Programming And More]{Multicast Test Tool - System Test Report - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={STR},
	pdfauthor={Team 1},
	pdfsubject={STR - System Test Report},
