...
\chead[Multicast Test Tool - System Requirements Specification - SPAM Software
Programming And More]{Multicast Test Tool - System Requirements Specification -
SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={SRS},
	pdfauthor={Team 1},
	pdfsubject={SRS - System Requirements Specification},
