...
\chead[Multicast Test Tool - Moduldokumentation Paket und Language - SPAM Software Programming And More]{Multicast Test Tool - Moduldokumentation Paket und Language - SPAM Software Programming And More} \cfoot[-\,\pagemark\,-]{-\,\pagemark\,-}% setzt Fußzeile [] -> chapterseiten; {} -> alle anderen Seiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pdf metadaten
\usepackage{hyperref}
\hypersetup{pdftitle={Moduldokumentation Paket und Language},
	pdfauthor={Team 1},
	pdfsubject={Moduldokumentation Paket und Language},
